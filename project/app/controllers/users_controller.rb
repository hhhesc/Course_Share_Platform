class UsersController < ApplicationController
  ...
  list_followings list_favor_articles edit_personal_sign list_questions space]
    ...
    def list_followers; end

    def list_followings; end

    def list_favor_articles; end
    ...
    def user_params
        params.require(:user).permit(:username, :realname, :studentcode, :personal_sign, :admin)
    end
    def permisson!
        unless current_user == @user || current_user.admin == 1
